...
const contactModal = document.getElementById('contactModal') ? new bootstrap.Modal(document.getElementById('contactModal')) : null;
const loginBtn = document.getElementById('loginBtn');
const signupBtn = document.getElementById('signupBtn');
const authModal = document.getElementById('authModal') ? new bootstrap.Modal(document.getElementById('authModal')) : null;
...
const trackingOrigin = document.getElementById('trackingOrigin');
const trackingDestination = document.getElementById('trackingDestination');
const trackingDelivery = document.getElementById('trackingDelivery');
const trackingUpdated = document.getElementById('trackingUpdated');
const trackingNotes = document.getElementById('trackingNotes');
const shipmentHistoryBtn = document.getElementById('shipmentHistoryBtn');
const shipmentActivitiesBody = document.getElementById('shipmentActivitiesBody');
const shipmentHistoryDetails = document.getElementById('shipmentHistoryDetails');
const shipmentHistoryModalEl = document.getElementById('shipmentHistoryModal');
const shipmentHistoryModal = shipmentHistoryModalEl ? new bootstrap.Modal(shipmentHistoryModalEl) : null;
